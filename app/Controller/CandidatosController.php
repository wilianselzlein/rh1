 ...
 */
	public function add() {
			...
			if ($this->Candidato->save($this->request->data)) {		
				...
				foreach($this->request->data['CandidatoFuncao'] as $CandidatoFuncao) {
					$CandidatoFuncao['candidato_id']=$candidato_id;
					$this->Candidato->CandidatoFuncao->create();
					$this->Candidato->CandidatoFuncao->save($CandidatoFuncao);
				}*/
				$model = new CandidatoFuncao();
				$savedata = array();
				$savedata['candidato_id'] = $this->Candidato->getLastInsertId();
				$savedata['funcao_id'] = $this->request->data['CandidatoFuncao']['funcao_id'];
				$model->create();
				$model->save($savedata);
